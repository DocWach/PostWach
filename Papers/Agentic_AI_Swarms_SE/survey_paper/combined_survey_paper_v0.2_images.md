...
![Figure 1: Survey methodology (PRISMA-informed).](figures/fig1_methodology.png)

*Figure 1: Survey methodology (PRISMA-informed).*
...
![Figure 2: Evolution of agent paradigms toward multi-agent AI for SE.](figures/fig2_timeline.png)

*Figure 2: Evolution of agent paradigms toward multi-agent AI for SE.*
...
![Figure 3: Taxonomy of agent architectures.](figures/fig3_architectures.png)

*Figure 3: Taxonomy of agent architectures.*
...
![Figure 4: Coordination mechanism design space.](figures/fig4_coordination.png)

*Figure 4: Coordination mechanism design space.*
...
![Figure 5: Tool and framework landscape for multi-agent SE.](figures/fig5_tools.png)

*Figure 5: Tool and framework landscape for multi-agent SE.*
