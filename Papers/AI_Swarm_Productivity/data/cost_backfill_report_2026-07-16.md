# Cost Backfill Report — AI_Swarm_Productivity (258 scorecards)
...
2. **Calibrate:** on scorecards recording both `tokens_output` and `agents_spawned>=2`,
   compute output-tokens-per-agent. n=11 clean points; per-agent (k tokens): [26, 35, 63, 65, 79, 80, 85, 100, 103, 121, 131].
   → median **80k**/agent, IQR [63k, 103k].
3. **Classify:** all 258 sessions typed by a 10-agent classifier sweep reading each scorecard +
   matching archive (258/258 agent-labeled). Types: derivation/Fable, paper/manuscript,
...
## Aggregate
- **cumulative subagent-output tokens (est):** 74.56M  (band 62.14M–91.18M)
- measured (14 cards): 16.65M; modeled (244 cards): 57.91M
- total agents spawned: 926
- **notional $ (API-rate, $13/M out):** $969 (band $808–$1,185); **actual marginal $ ≈ 0**.
...
|---|---|---|---|---|---|
| postwach | 66.08M | 55.45M–80.30M | mixed (13m/200e) | 213 | 818 |
...
| sysmlv2 | 0.38M | 0.33M–0.45M | mixed (1m/6e) | 7 | 7 |
...
|---|---|---|---|---|---|
| derivation/Fable | 31.66M | 28.03M–36.52M | mixed (7m/18e) | 25 | 390 |
| paper/manuscript | 18.89M | 14.97M–24.14M | mixed (2m/94e) | 96 | 236 |
| ops/tooling | 14.76M | 11.59M–18.99M | estimated | 87 | 184 |
| review/refverify | 5.64M | 4.66M–6.95M | mixed (3m/32e) | 35 | 71 |
| governance | 3.61M | 2.89M–4.58M | mixed (2m/13e) | 15 | 45 |

### By week
| week | est tokens | band | flag | cards | agents |
|---|---|---|---|---|---|
| 2026-W29 | 19.60M | 17.31M–22.66M | mixed (5m/9e) | 14 | 242 |
